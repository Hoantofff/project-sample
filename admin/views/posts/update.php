            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="row">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <select name="cate_id" class="form-control">
                                <?php foreach ($categories as $category): ?>
                                    <option <?= $post['p_cate_id'] == $category['id'] ? 'selected' : null ?> value="<?= $category['id'] ?>"><?= $category['name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="mb-3 mt-3">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <textarea name="content" id="content"><?= $post['p_content'] ?></textarea>
                    </div>
                    <div class="mb-3 mt-3">
                        <label for="excerpt" class="form-label">Excerpt:</label>
                        <textarea name="excerpt" id="excerpt"><?= $post['p_excerpt'] ?></textarea>
                    </div>
                </div>
